document.addEventListener("DOMContentLoaded", function () {
    ...
    const descriptionsByPage = {
        ...
        "work3.html": [
            "フィットネスのバナーになります。こちらは他のバナーとは違い女性らしさをイメージして制作しました。暖色のニュアンスカラーを使用し、落ち着いた雰囲気に仕上げました。",
            "フィットネスのバナー２枚目になります。こちらのバナーは全体的にシンプルかつ見やすく必要な情報を取り入れられるようなデザインにしました。フォントはキリッとしたフォントを使用することで可読性とスマートなイメージにしました。",
            "フィットネスのバナー３枚目になります。１、２枚目とは違いポップなデザインにしました。緑を使いながら、暖色を多めに使用したりフォントを太めのものを使用することで「元気」なイメージを与える作品にしました。"
        ],
        "work4.html": [
